...
const ConfirmacionPedido = () => {
  ...
  const nombreUsuario =
    localStorage.getItem("userName") || "viajero gastronómico";
  ...
  const chefInfo = {
    ...
    imagen:
      "https://img.freepik.com/foto-gratis/retrato-chef-profesional-cocina_23-2150703107.jpg",
  ...
  const fraseAleatoria =
    frasesInspiradoras[Math.floor(Math.random() * frasesInspiradoras.length)];
      ...
      <div className={styles.loadingContainer}>
        <div className={styles.loadingContent}>
          ...
          <p className={styles.loadingSubtext}>
            Estamos dando los últimos toques a tu pedido
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className={styles.container}>
      ...
      <div
        className={`${styles.confirmationCard} ${showAnimation ? styles.show : ""}`}
      >
        {/* Sello de éxito */}
        ...
        <div className={styles.headerMessage}>
          <h1 className={styles.title}>
            ...
            <span className={styles.storyTitle}>
              Tu viaje culinario ha comenzado
            </span>
          </h1>
          <div className={styles.story}>
            <p>
              En este momento, nuestros <strong>maestros sushi</strong> están
              seleccionando los mejores ingredientes para crear tu pedido. Cada
              pieza es elaborada con la misma dedicación y tradición que nos ha
              acompañado por generaciones.
            </p>
            <p className={styles.inspiration}>"{fraseAleatoria}"</p>
          </div>
        </div>
          ...
          <div className={styles.detailCard}>
            ...
            <div className={styles.detailInfo}>
              ...
              <span className={styles.detailSub}>
                {chefInfo.experiencia} de experiencia
              </span>
            </div>
          </div>
        </div>
        ...
        <div className={styles.footerMessage}>
          <p>
            💫 Gracias por ser parte de nuestra historia. En The Sushi Room,
            cada pedido es una experiencia única.
          </p>
        </div>
      </div>
    </div>
